...
from zSpectral_Normalization import DCGenerator, DCDiscriminator
...
def create_parser():
    ...
    parser.add_argument('--checkpoint_dir', default='./checkpoints_SN_GAN')
    parser.add_argument('--sample_dir', type=str, default='./SN_GAN')
